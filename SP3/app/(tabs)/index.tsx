...
// Список міст — спадок SP2, зелений і сьогодні не змінюється: FlatList,
// картки, навігація. Відбулося одне: наступний екран більше не показує
// заготовлений текст, а ходить у мережу. Уся робота пари — на екрані погоди,
// TODO(3) і TODO(4) у app/city/[id].tsx.
